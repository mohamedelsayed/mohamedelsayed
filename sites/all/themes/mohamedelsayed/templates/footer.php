	<div class="footer" >
		<div class="container wow fadeInDownBig animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
			<p>Copyright © 2016 . All rights reserved | Design by AHMED ELSAYED</p>
		</div>
	</div>
